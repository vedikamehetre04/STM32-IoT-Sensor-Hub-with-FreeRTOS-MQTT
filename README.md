...
graph LR
    ...
    %% Main Controller
    STM[STM32F103C8T6<br/>Blue Pill]
    ...
    %% UART Logger / Serial Monitor
    UART[UART Debug / Serial Monitor]
    ...
    linkStyle 5 stroke:gray,stroke-width:3px

    linkStyle 6 stroke:yellow,stroke-width:4px

    linkStyle 7 stroke:green,stroke-width:4px
    linkStyle 8 stroke:#2bbbad,stroke-width:4px

    linkStyle 9 stroke:green,stroke-width:4px
    linkStyle 10 stroke:#2bbbad,stroke-width:4px

    linkStyle 11 stroke:gold,stroke-width:3px,stroke-dasharray: 5 5
    linkStyle 12 stroke:gold,stroke-width:3px,stroke-dasharray: 5 5
```
